...
@section('content')
    ...
    <div class="space-y-5">
        <div class="flex flex-col gap-4 xl:flex-row xl:items-center xl:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-slate-400">
                    Kelola informasi akun dan keamanan password administrator.
                </p>
            </div>
        ...
        <div class="grid gap-5 xl:grid-cols-[320px_minmax(0,1fr)]">
            ...
            <form id="profile-form" action="{{ route('admin.profil.update') }}" method="POST"
                data-original-name="{{ $user->name }}" data-original-email="{{ $user->email }}" class="space-y-5">
                @csrf
                @method('PUT')
